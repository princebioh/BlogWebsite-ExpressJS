...
const homeDoc = new BlogPost({title: "Home Page", body: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."});
const aboutDoc = new BlogPost({title: "About Page", body: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."});
const contactDoc = new BlogPost({title: "Contact Page", body: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."});

// BlogPost.insertMany([homeDoc, aboutDoc, contactDoc]);
